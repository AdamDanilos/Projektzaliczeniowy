...
public class MyStore_testlab_test {
    ...
    @And("user add {string}, {string}, {string}, {string}, {string}, {string} click SAVE button")
    public void useradd(String alias, String address,String PostalCode, String city, String country, String phone) {
